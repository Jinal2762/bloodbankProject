...
urlpatterns = [
    ...
    path('donor_form/', views.insert_donor),
    path('receiver_form/', views.insert_receiver),
    ...
    path('hospital_form/', views.insert_hospital),
    ...
    path('edit_receiver/<int:id>', views.edit_receiver),
    path('edit_donor/<int:id>', views.edit_donor),
    ...
    path('edit_hospital/<int:id>', views.edit_hospital),
